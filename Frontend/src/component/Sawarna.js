...
import './../style/Sawarna.css';
import axios from 'axios';

class Sawarna extends Component {
    constructor(){
        super();
      ...
      componentWillMount(){
        axios.get('https://aqueous-scrubland-39513.herokuapp.com/data/Pantai%20Tanjung%20Layar%20Sawarna')
        .then((ambilData)=>{
